...
export const USDC_APOTHEM = new Token(
  SupportedChainId.APOTHEM,
  '0xefa09D3d73C07B3996eC018a408B63f54A373D3b',
  6,
  'USDC',
  'USD//C'
)
...
export const USDC: { [chainId in SupportedChainId]: Token } = {
  ...
  [SupportedChainId.APOTHEM]: USDC_APOTHEM,
}
...
export const XSP2 = new Token(
  SupportedChainId.APOTHEM,
  '0x0b0B2599D9E2d4EA8288b1Ec317283df5880Ef1E',
  18,
  'XSP2',
  'Xinfin'
)
...
export const UNI: { [chainId: number]: Token } = {
  ...
  [SupportedChainId.APOTHEM]: new Token(SupportedChainId.APOTHEM, UNI_ADDRESS[51], 18, 'UNI', 'Uniswap'),
}
...
export const WRAPPED_NATIVE_CURRENCY: { [chainId: number]: Token | undefined } = {
  ...
  [SupportedChainId.APOTHEM]: new Token(
    SupportedChainId.APOTHEM,
...
export const TOKEN_SHORTHANDS: { [shorthand: string]: { [chainId in SupportedChainId]?: string } } = {
  USDC: {
    ...
    [SupportedChainId.APOTHEM]: USDC_APOTHEM.address,
  },
}
